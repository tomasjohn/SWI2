...
public class SampleData {
	...
	Zakaznik z1 = zakaznik(5, "Honza Pepa", "Uliční 97, Brno");
	Zakaznik z2 = zakaznik(10, "Jarda Jágr", "Kladenská 68, Kladno");
	Zakaznik z3 = zakaznik(5, "Kája Gotů", "Nemocniční 1, Praha");
	Zakaznik z4 = zakaznik(0, "Bruce Wane", "Cavely 1939, Gotham");
	Zakaznik z5 = zakaznik(15, "Wade Wilson", "Holywood 5, Los Angales");
